    ...
    <div class="essay_content">
        ...
        <div class="content_content">
            ...
            <ul>
                <?php
                $dao = new video_dao();
                $result = $dao->listVideos(0, 100, 0);
                while ($row = $result->fetch()) {
                    $video = new video($row);
                    ?>
                    <li>
                        <a href="/video/content.php?id=<?php echo $video->id?>">
                            <p class="title"><?php echo $video->title?></p>
                            <p class="time"><?php echo $video->create_date?></p>
                            <p class="subtitle"><?php echo $video->sub_title?></p>
                        </a>
                    </li>
                <?php
                }
